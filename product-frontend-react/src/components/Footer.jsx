const Footer = () => {
  ...
  return (
    <footer className="bg-dark-blue-900 py-12 px-4">
      <div className="container mx-auto">
        ...
        {/* Copyright */}
        <div className="border-t border-dark-blue-700 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            &copy; {currentYear} Aahaas Ecommerce. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
